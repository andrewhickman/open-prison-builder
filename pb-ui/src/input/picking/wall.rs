    ...
    fn set_position(&mut self, commands: &mut Commands, pos: Vec2) {
        match *self {
            ...
            CreateWallState::SelectEnd { start } => {
                ...
                let wall = Entity::PLACEHOLDER;
                // let wall = commands.spawn(Wall { start, end }).id();
            ...
            CreateWallState::PreviewEnd { start, wall, end } => {
                ...
                // commands.entity(wall).insert(Wall { start, end });
    ...
    pub fn vertex_click(
        ...
        match *self {
            ...
            CreateWallState::PreviewEnd {
                ...
                commands.spawn(Wall::new(start, end)).set_parent(root);
